...
{
  TFT_clear_screen();
  TFT_string( 3, 3,Cyan,   Black,"   (6)번 줄을 튜닝합니다.");
  TFT_string( 3, 6,Yellow, Black,"   (5)번 줄을 튜닝합니다.");
  TFT_string( 3, 9,Cyan,   Black,"   (4)번 줄을 튜닝합니다.");
  TFT_string( 3,12,Yellow, Black,"   (3)번 줄을 튜닝합니다.");
  TFT_string( 3,15,Cyan,   Black,"   (2)번 줄을 튜닝합니다.");
  TFT_string( 3,18,Yellow, Black,"   (1)번 줄을 튜닝합니다.");
  TFT_string( 3,28,White,   Blue," KEY1(실행) ");
...
void Display_arrow(U08 arrow)
{
  TFT_string(3, 3,Cyan,   Black,"  ");
  TFT_string(3, 6,Yellow, Black,"  ");
  TFT_string(3, 9,Cyan,   Black,"  ");
  TFT_string(3,12,Yellow, Black,"  ");
  TFT_string(3,15,Cyan,   Black,"  ");
  TFT_string(3,18,Yellow, Black,"  ");
  TFT_string(3,arrow*3, White,Black,">>");
}
